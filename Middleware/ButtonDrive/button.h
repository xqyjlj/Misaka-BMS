...
#define PRINT_INFO_ENABLE           0       /* 打印个人信息 */
    ...
    #define PRINT_DEBUG(fmt, args...)    do{(rt_kprintf("\n[DEBUG] >> "), rt_kprintf(fmt, ##args));}while(0)
#else
    #define PRINT_DEBUG(fmt, args...)
#endif

#if PRINT_ERR_ENABLE
    #define PRINT_ERR(fmt, args...)      do{(rt_kprintf("\n[ERR] >> "), rt_kprintf(fmt, ##args));}while(0)
#else
    #define PRINT_ERR(fmt, args...)
#endif

#if PRINT_INFO_ENABLE
    #define PRINT_INFO(fmt, args...)     do{(rt_kprintf("\n[INFO] >> "), rt_kprintf(fmt, ##args));}while(0)
#else
