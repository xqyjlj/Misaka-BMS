...
/* debug level log */
    ...
    #undef  log_d
#endif
#define log_d(fmt, ...)  LOG_D_NAME("fal", fmt, ##__VA_ARGS__)
...
/* error level log */
    ...
    #undef  log_e
#endif
#define log_e(fmt, ...)  LOG_E_NAME("fal", fmt, ##__VA_ARGS__)

/* info level log */
#ifdef  log_i
    #undef  log_i
#endif
#define log_i(fmt, ...)  LOG_I_NAME("fal", fmt, ##__VA_ARGS__)
